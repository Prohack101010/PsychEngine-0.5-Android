...
class DialogueEditorState extends MusicBeatState
{
	...
	override function update(elapsed:Float) {
		...
		if(!blockInput) {
			...
			if(#if mobile _virtualpad.buttonA.justPressed || #end FlxG.keys.justPressed.SPACE) {
				reloadText(speedStepper.value);
			}
			...
			var controlAnim:Array<Bool> = [
				FlxG.keys.justPressed.W #if mobile || _virtualpad.buttonUp.justPressed #end,
				FlxG.keys.justPressed.S #if mobile || _virtualpad.buttonDown.justPressed #end
			];
			var controlText:Array<Bool> = [
				FlxG.keys.justPressed.D #if mobile || _virtualpad.buttonRight.justPressed #end,
				FlxG.keys.justPressed.A #if mobile || _virtualpad.buttonLeft.justPressed #end
			];
			...
			if(#if mobile _virtualpad.buttonY.justPressed || #end FlxG.keys.justPressed.O) {
				...
				changeText();
			} else if(#if mobile _virtualpad.buttonX.justPressed || #end FlxG.keys.justPressed.P) {
